...
public:
    ...
    static const int IMAGE_TOO_LARGE=4; ///< The image is too large and does not fit into
/**
     ...
     */
    void setPixel(int x, int y, const Byte &v);
    /**
     ...
     */
    void setPos(int i, const Byte &v);
    /**
     ...
     */
    void extractObjects(Image set [], int &nimages, int maximages, double tolerance=Histogram::HISTOGRAM_TOLERANCE);
    /**
   ...
   /**
    ...
    bool hideText( char source [], int k=0);
...
private:
     ...
     * @param x newheight value. intput param
     * @param y newwidth value. intput param
     */
    void setSize(int height, int width);

    /**
     * @brief sets the Image
     * @param height number of rows. intput param
     * @param width number of colums. intput param
     */
    
    void setImage(int height, int width);
