...
@note for MP-DGIM, MP-IADE, MP-II (group B)
@author estudiante1: Córdoba Lillo, Teresa 
@author estudiante2: Vallejo Ruiz, Elena
 ...
 * Byte remains unchanged.  (0 means the rightmost position). Modifier method.
     ...
     */
    void decomposeByte(int posits[], int &n) ;
     ...
     */
    void mergeByte(const Byte merge, int percentage);
};
